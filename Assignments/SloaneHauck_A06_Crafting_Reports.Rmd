...
```{r example.table}
library(knitr)
table <- data.frame(Item = c("Filename", "Date", "Source"),
                    Value = c("EPAair_O3_PM25_NC1819_Processed.csv", "2018-2019", 
                              "EPA Air Quality System (AQS)"))

knitr::kable(table, align = c('r', 'l'))
```
...
```{r project.setup, results='hide', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r ozone plot 18, echo=FALSE, fig.align='left', fig.cap='2018 monthly ozone levels', warning=FALSE, fig.dim=c(6,3)}
...
```
\nopagebreak
```{r ozone plot 19, echo=FALSE, fig.align='left', fig.cap='2019 monthly ozone levels', warning=FALSE, fig.dim=c(6,3)}
