...
> Answer: No there is not, this is obvious by the R-squared value in the lm version of the ANOVA which shows that different lakes only account for 4.1% of variability.
