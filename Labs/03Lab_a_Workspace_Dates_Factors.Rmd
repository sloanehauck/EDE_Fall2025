...
file_folder <- here('Data', 'Raw/')
files <- dir(file_folder, pattern = "EPAair_O3", full.names = TRUE)
...
str_past <- "55-feb-3"
str_past_ymd <- ymd(str_past)
fixed_str_past <- fix.early.dates(str_past_ymd, cutoff = 24)
...
usgs_flow_data$month <- factor(usgs_flow_data$month, labels = month.abb)
