...
> Add notes here: We can track how these metrics might be changing over time. This can be used to look at cyanoHABs for example or measure primary prodcuer productivity. 
...
NTL.phys.data.Tuesday1 <- filter(NTL.phys.data, year4 <= 1999 & year4 >= 1990 & lakename == "Tuesday Lake")

```
Question: Why don't we filter using row numbers?

> Answer: There are too many rows
...
# East Long Lake on 7/16/1998 at 0.5 ft
