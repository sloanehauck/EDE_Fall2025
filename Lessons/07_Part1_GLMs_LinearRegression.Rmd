...
>  We can see that there is a negative relationship between depth and light and that there is a meaningful relationship between the two since there is a low p value.
...
irradiancebydepth2 <- 
    ggplot(PeterPaul.chem.nutrients, aes(x = depth, y = irradianceWater, color = depth)) +
    geom_point() +
    scale_y_log10() +  #log transformed values for irradianceWater
    geom_smooth(method = 'lm', se = FALSE, color = "black") +
