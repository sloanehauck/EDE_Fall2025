...
> For discussion: Can you give examples of ethical and unethical web scraping? Unethical scraping would be scraping from websites that have in their terms of services that they don't want their data scraped. Alternatively, if the site includes APIs or other methods to make scraping simpler, it's more ethical.
